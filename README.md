# Hey, I'm Jeff Schedin

By day, I'm a "full stack" Sr. Technology leader implementing and operating Cloud AI and Data applications and program delivery.  By night, I build tools that make cloud development less painful.
...
`Azure` `TypeScript` `Python` `Node.js` `VS Code Extensions` `FastAPI` `Cloud Architecture` `Data` `SQL`

---

### Connect

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=flat&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/jeffschedin/)

---

*I believe the best developer tools are the ones that solve a specific problem really well.*
